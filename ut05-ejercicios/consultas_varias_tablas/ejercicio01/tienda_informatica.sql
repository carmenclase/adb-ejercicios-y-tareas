...
SELECT producto.id, precio, fabricante.nombre FROM producto, fabricante ORDER BY precio LIMIT 1;
-- 5. Devuelve el nombre del producto, su precio y el nombre de su fabricante, del producto más caro.
SELECT producto.id, precio, fabricante.nombre FROM producto, fabricante ORDER BY precio DESC LIMIT 1;
